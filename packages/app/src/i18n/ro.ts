export const dict = {
  ...
  "desktop.menu.documentation": "Documentație MindScript Studio",
  ...
  "desktop.menu.ariaLabel": "Meniu MindScript Studio",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra MindScript Studio s-a închis neașteptat",
  "desktop.recovery.unresponsive": "MindScript Studio nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea MindScript Studio a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea MindScript Studio s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în MindScript Studio.",
  ...
  "dialog.server.description": "Schimbă serverul MindScript Studio la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică MindScript Studio în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează MindScript Studio în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează MindScript Studio în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează MindScript Studio în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca MindScript Studio să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune MindScript Studio ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei MindScript Studio",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, MindScript Studio nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul MindScript Studio în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul MindScript Studio pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă MindScript Studio urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema MindScript Studio.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea MindScript Studio",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune MindScript Studio.",
