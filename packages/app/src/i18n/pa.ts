export const dict = {
  ...
  "desktop.menu.documentation": "MindScript Studio دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "MindScript Studio دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "MindScript Studio جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOpencode": "MindScript Studio دی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} وچ MindScript Studio انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.model.unpaid.freeModels.title": "MindScript Studio دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے MindScript Studio وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے MindScript Studio وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے MindScript Studio وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.server.description": "ایہہ ایپ کس MindScript Studio سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOpencode": "MindScript Studio چیک کر رئے آں...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} چ MindScript Studio دی جانچ پڑتال...",
  "wsl.onboarding.updatingOpencode": "MindScript Studio نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} وچ MindScript Studio نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} وچ MindScript Studio نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOpencode": "MindScript Studio اپ ڈیٹ کرو",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio {{distro}} چ تیار اے۔",
  "wsl.onboarding.opencodeReady": "MindScript Studio تیار اے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} وچ MindScript Studio انسٹال کرو۔",
  "wsl.onboarding.installOpencode": "MindScript Studio انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MindScript Studio دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر MindScript Studio دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MindScript Studio ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع MindScript Studio ٹیم نوں دیو",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، MindScript Studio ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر MindScript Studio سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "MindScript Studio لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے MindScript Studio کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا MindScript Studio سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "MindScript Studio نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں MindScript Studio لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی MindScript Studio دا تازہ ترین ورژن چلا رئے او۔",
