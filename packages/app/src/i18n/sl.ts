export const dict = {
  ...
  "desktop.menu.documentation": "MindScript Studio Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno MindScript Studio se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "MindScript Studio se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev MindScript Studio ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev MindScript Studio je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v MindScript Studio.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom MindScript Studio se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje MindScript Studio ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje MindScript Studio v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje MindScript Studio ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje MindScript Studio v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite MindScript Studio v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite MindScript Studio v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko MindScript Studio doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica MindScript Studio ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi MindScript Studio",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, MindScript Studio še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik MindScript Studio znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako MindScript Studio izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali MindScript Studio sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo MindScript Studio.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene MindScript Studio",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico MindScript Studio.",
