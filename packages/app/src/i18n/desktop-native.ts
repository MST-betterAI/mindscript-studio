...
export const DESKTOP_NATIVE_ENGLISH = {
  "desktop.menu.app": "MindScript Studio",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio failed to load",
  "desktop.recovery.terminated": "MindScript Studio window terminated unexpectedly",
  "desktop.recovery.unresponsive": "MindScript Studio is not responding",
  ...
  "desktop.wsl.error.installOpencode": "MindScript Studio installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
