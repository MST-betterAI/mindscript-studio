export const dict = {
  ...
  "desktop.menu.documentation": "Документація MindScript Studio",
  ...
  "desktop.menu.ariaLabel": "Меню MindScript Studio",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити MindScript Studio",
  "desktop.recovery.terminated": "Роботу вікна MindScript Studio несподівано завершено",
  "desktop.recovery.unresponsive": "MindScript Studio не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити MindScript Studio",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення MindScript Studio завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у MindScript Studio.",
  ...
  "dialog.server.description": "Перемкніть сервер MindScript Studio, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка MindScript Studio у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення MindScript Studio у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть MindScript Studio у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть MindScript Studio у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в MindScript Studio потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія MindScript Studio ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді MindScript Studio",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, MindScript Studio ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер MindScript Studio всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд MindScript Studio на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи MindScript Studio використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему MindScript Studio.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску MindScript Studio",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію MindScript Studio.",
