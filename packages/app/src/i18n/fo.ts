export const dict = {
  ...
  "desktop.menu.documentation": "MindScript Studio Skjøl",
  ...
  "desktop.menu.ariaLabel": "MindScript Studio valmynd",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio miseydnaðist at heinta",
  "desktop.recovery.terminated": "MindScript Studio vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "MindScript Studio svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "MindScript Studio uppsetingin miseydnaðist",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í MindScript Studio.",
  ...
  "dialog.server.description": "Skift hvønn MindScript Studio ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna MindScript Studio í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring MindScript Studio í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør MindScript Studio í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio er klárt í {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set MindScript Studio upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn MindScript Studio kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani MindScript Studio aftur.",
  ...
  "help.tabs.introduction": "MindScript Studio Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av MindScript Studio ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til MindScript Studio toymið",
  ...
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, MindScript Studio stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "MindScript Studio Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr MindScript Studio ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu MindScript Studio sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um MindScript Studio fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu MindScript Studio er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá MindScript Studio byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av MindScript Studio.",
