export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu MindScript Studio",
  ...
  "desktop.recovery.loadFailed": "Không tải được MindScript Studio",
  "desktop.recovery.terminated": "Cửa sổ MindScript Studio đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "MindScript Studio không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được MindScript Studio",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật MindScript Studio nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do MindScript Studio cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong MindScript Studio.",
  ...
  "dialog.server.description": "Chuyển máy chủ MindScript Studio mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra MindScript Studio trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật MindScript Studio trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật MindScript Studio trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt MindScript Studio trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi MindScript Studio có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của MindScript Studio ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm MindScript Studio",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: MindScript Studio chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ MindScript Studio bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của MindScript Studio trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem MindScript Studio tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của MindScript Studio.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi MindScript Studio khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của MindScript Studio.",
