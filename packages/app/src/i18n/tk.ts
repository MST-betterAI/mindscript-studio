export const dict = {
  ...
  "desktop.menu.documentation": "MindScript Studio Resminamalar",
  ...
  "desktop.menu.ariaLabel": "MindScript Studio menýusy",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio ýükläp bilmedi",
  "desktop.recovery.terminated": "MindScript Studio penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "MindScript Studio jogap berenok",
  ...
  "desktop.wsl.error.installOpencode": "MindScript Studio gurmak şowsuz",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "MindScript Studio tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we MindScript Studio-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini MindScript Studio-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini MindScript Studio-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.server.description": "Bu programmanyň haýsy MindScript Studio serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "MindScript Studio barlamak ...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde MindScript Studio barlanýar...",
  "wsl.onboarding.updatingOpencode": "MindScript Studio täzelenmek ...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de MindScript Studio täzelenmek ...",
  "wsl.onboarding.updateOpencodeIn": "MindScript Studio-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "MindScript Studio täzeläň",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio {{distro}}-de taýýar.",
  "wsl.onboarding.opencodeReady": "MindScript Studio taýýar.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de MindScript Studio guruň.",
  "wsl.onboarding.installOpencode": "MindScript Studio guruň",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) MindScript Studio WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra MindScript Studio açyň.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin MindScript Studio ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy MindScript Studio toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, MindScript Studio entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "MindScript Studio serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "MindScript Studio üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "MindScript Studio enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "MindScript Studio ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "MindScript Studio-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "MindScript Studio işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "MindScript Studio-iň iň soňky wersiýasyny işleýärsiňiz.",
