export const dict = {
  ...
  "desktop.menu.documentation": "MindScript Studio Documentació",
  ...
  "desktop.menu.ariaLabel": "menú MindScript Studio.",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra MindScript Studio s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "MindScript Studio no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de MindScript Studio ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a MindScript Studio.",
  ...
  "dialog.server.description": "Canvia a quin MindScript Studio servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant MindScript Studio a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant MindScript Studio a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza MindScript Studio a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu MindScript Studio a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que MindScript Studio pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de MindScript Studio ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip MindScript Studio.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que MindScript Studio encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "MindScript Studio Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor MindScript Studio dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu MindScript Studio al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si MindScript Studio segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de MindScript Studio.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï MindScript Studio.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de MindScript Studio.",
