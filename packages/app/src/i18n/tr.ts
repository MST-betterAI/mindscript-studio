...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "MindScript Studio yüklenemedi",
  "desktop.recovery.terminated": "MindScript Studio penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "MindScript Studio yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "MindScript Studio kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "MindScript Studio tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve MindScript Studio'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak MindScript Studio'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak MindScript Studio'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi MindScript Studio sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "MindScript Studio kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde MindScript Studio kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "MindScript Studio güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde MindScript Studio güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki MindScript Studio'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "MindScript Studio'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde MindScript Studio hazır.",
  "wsl.onboarding.opencodeReady": "MindScript Studio hazır.",
  "wsl.onboarding.installOpencodeIn": "MindScript Studio'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "MindScript Studio'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MindScript Studio'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından MindScript Studio'u tekrar açın.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MindScript Studio'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı MindScript Studio ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: MindScript Studio henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "MindScript Studio Masaüstü",
  ...
  "settings.desktop.wsl.description": "MindScript Studio sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "MindScript Studio'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "MindScript Studio'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "MindScript Studio'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "MindScript Studio'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "MindScript Studio başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "MindScript Studio'un en son sürümünü kullanıyorsunuz.",
