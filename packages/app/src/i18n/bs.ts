export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za MindScript Studio",
  ...
  "desktop.menu.ariaLabel": "MindScript Studio meni",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor MindScript Studio-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "MindScript Studio ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija MindScript Studio-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje MindScript Studio-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u MindScript Studio-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u MindScript Studio-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u MindScript Studio-u.",
  ...
  "dialog.server.description": "Promijeni na koji se MindScript Studio server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera MindScript Studio u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje MindScript Studio u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj MindScript Studio u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj MindScript Studio u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi MindScript Studio mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija MindScript Studio-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku MindScript Studio timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: MindScript Studio još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni MindScript Studio server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u MindScript Studio-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako MindScript Studio izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li MindScript Studio prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu MindScript Studio-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se MindScript Studio pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju MindScript Studio-a.",
