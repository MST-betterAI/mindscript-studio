...
const desktop = [
  ...
  "Kis méret",
  "Teljes méret",
  "MindScript Studio dokumentáció",
  "Támogatási fórum",
  "Visszajelzés küldése",
  "Hiba jelentése",
  "MindScript Studio menü",
  ...
  "Kilépés",
  "Az MindScript Studio betöltése sikertelen",
  "Az MindScript Studio ablaka váratlanul leállt",
  "Az MindScript Studio nem válaszol",
  ...
  "Az MindScript Studio telepítése sikertelen",
  ...
  "Az MindScript Studio nincs telepítve ebben: {{distro}}",
  "Az MindScript Studio frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "A MindScript Studio ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a MindScript Studio-ben.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a MindScript Studio-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a MindScript Studio-ben.",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik MindScript Studio szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingOpencode": "MindScript Studio ellenőrzése...",
  "wsl.onboarding.checkingOpencodeIn": "MindScript Studio ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingOpencode": "MindScript Studio frissítése...",
  "wsl.onboarding.updatingOpencodeIn": "MindScript Studio frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateOpencodeIn": "Frissítse a MindScript Studio-t a {{distro}}-ben.",
  "wsl.onboarding.updateOpencode": "Frissítse a MindScript Studio-t",
  "wsl.onboarding.opencodeReadyIn": "A MindScript Studio készen áll a {{distro}}-ben.",
  "wsl.onboarding.opencodeReady": "A MindScript Studio készen áll.",
  "wsl.onboarding.installOpencodeIn": "Telepítse a MindScript Studio-t a {{distro}}-be.",
  "wsl.onboarding.installOpencode": "Telepítse a MindScript Studio-t",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "A MindScript Studio nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a MindScript Studio hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A MindScript Studio nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a MindScript Studio programot.",
  ...
  "help.tabs.introduction": "A MindScript Studio Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A MindScript Studio ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a MindScript Studio csapatának",
  ...
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a MindScript Studio még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A MindScript Studio ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "MindScript Studio asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a MindScript Studio szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a MindScript Studio kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a MindScript Studio az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a MindScript Studio a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a MindScript Studio témáját.",
  ...
  "settings.updates.row.startup.description": "A MindScript Studio indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a MindScript Studio legújabb verzióját futtatja.",
