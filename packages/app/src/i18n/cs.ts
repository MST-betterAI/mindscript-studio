export const dict = {
  ...
  "desktop.menu.documentation": "MindScript Studio Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka MindScript Studio",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio se nepodařilo načíst",
  "desktop.recovery.terminated": "MindScript Studio okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "MindScript Studio nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "MindScript Studio instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v MindScript Studio.",
  ...
  "dialog.server.description": "Přepněte, ke kterému MindScript Studio serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola MindScript Studio v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace MindScript Studio v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace MindScript Studio v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte MindScript Studio do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než MindScript Studio může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze MindScript Studio ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu MindScript Studio",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: MindScript Studio zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server MindScript Studio uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled MindScript Studio na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude MindScript Studio následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma MindScript Studio.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění MindScript Studio",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi MindScript Studio.",
