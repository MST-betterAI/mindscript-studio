export const dict = {
  ...
  "desktop.menu.documentation": "MindScript Studio hujjatlari",
  ...
  "desktop.menu.ariaLabel": "MindScript Studio menyusi",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio yuklanmadi",
  "desktop.recovery.terminated": "MindScript Studio oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "MindScript Studio javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "MindScript Studio oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "MindScript Studio tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va MindScript Studio’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va MindScript Studio da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va MindScript Studio da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi MindScript Studio serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "MindScript Studio tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "MindScript Studio {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "MindScript Studio yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "MindScript Studio {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "MindScript Studio-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "MindScript Studio-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "MindScript Studio tayyor.",
  "wsl.onboarding.installOpencodeIn": "MindScript Studio-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "MindScript Studio-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MindScript Studio WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra MindScript Studio-ni qayta oching.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MindScript Studio ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida MindScript Studio jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, MindScript Studio hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "MindScript Studio bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi MindScript Studio serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "MindScript Studio uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "MindScript Studio qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "MindScript Studio tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "MindScript Studio mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "MindScript Studio ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz MindScript Studio oxirgi versiyasini ishga tushiryapsiz.",
