export const dict = {
  ...
  "desktop.menu.documentation": "MindScript Studio-documentatie",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio kan niet worden geladen",
  "desktop.recovery.terminated": "Het MindScript Studio-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "MindScript Studio reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van MindScript Studio is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De MindScript Studio-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in MindScript Studio te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in MindScript Studio te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in MindScript Studio te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke MindScript Studio-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "MindScript Studio controleren...",
  "wsl.onboarding.checkingOpencodeIn": "MindScript Studio controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "MindScript Studio bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "MindScript Studio bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk MindScript Studio bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "MindScript Studio bijwerken",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer MindScript Studio in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat MindScript Studio een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens MindScript Studio opnieuw.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van MindScript Studio ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het MindScript Studio-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: MindScript Studio ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de MindScript Studio-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe MindScript Studio eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of MindScript Studio het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van MindScript Studio aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer MindScript Studio wordt gestart",
  ...
  "settings.updates.toast.latest.title": "MindScript Studio is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van MindScript Studio.",
