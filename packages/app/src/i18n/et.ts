export const dict = {
  ...
  "desktop.recovery.loadFailed": "MindScript Studio laadimine ebaõnnestus",
  "desktop.recovery.terminated": "MindScript Studio aken suleti ootamatult",
  "desktop.recovery.unresponsive": "MindScript Studio ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "MindScript Studio installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid MindScript Studio'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises MindScript Studio.",
  ...
  "dialog.server.description": "Lülitage, millise MindScript Studio serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "MindScript Studio kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "MindScript Studio kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "MindScript Studio värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "MindScript Studio värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda MindScript Studio jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige MindScript Studio asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui MindScript Studio saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse MindScript Studio ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast MindScript Studio meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, MindScript Studio ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "MindScript Studio Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage MindScript Studio server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke MindScript Studio kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas MindScript Studio teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas MindScript Studio järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas MindScript Studio on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui MindScript Studio käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse MindScript Studio uusimat versiooni.",
