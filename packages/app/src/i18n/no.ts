...
export const dict = {
  ...
  "desktop.menu.documentation": "MindScript Studio-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "MindScript Studio-meny",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio kunne ikke lastes inn",
  "desktop.recovery.terminated": "MindScript Studio-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "MindScript Studio svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av MindScript Studio mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av MindScript Studio er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i MindScript Studio.",
  ...
  "dialog.server.description": "Bytt hvilken MindScript Studio-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av MindScript Studio ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til MindScript Studio-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at MindScript Studio ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør MindScript Studio-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for MindScript Studio",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan MindScript Studio ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om MindScript Studio skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i MindScript Studio.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når MindScript Studio starter",
  ...
  "settings.updates.toast.latest.title": "MindScript Studio er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av MindScript Studio.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker MindScript Studio i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer MindScript Studio i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater MindScript Studio i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer MindScript Studio i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før MindScript Studio kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter MindScript Studio på nytt.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
