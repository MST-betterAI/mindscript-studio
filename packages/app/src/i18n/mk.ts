export const dict = {
  ...
  "desktop.menu.documentation": "MindScript Studio Документација",
  ...
  "desktop.menu.ariaLabel": "MindScript Studio мени",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio не успеа да се вчита",
  "desktop.recovery.terminated": "Прозорецот MindScript Studio неочекувано заврши",
  "desktop.recovery.unresponsive": "MindScript Studio не реагира",
  ...
  "desktop.wsl.error.installOpencode": "инсталацијата MindScript Studio не успеа",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio не е инсталиран во {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio ажурирањето е завршено, но {{distro}} сè уште известува {{installed}}; се очекува {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатни модели обезбедени од MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Внесете го вашиот клуч {{provider}} API за да ја поврзете вашата сметка и да користите {{provider}} модели во MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "да го соберете вашиот код за авторизација за да ја поврзете вашата сметка и да користите {{provider}} модели во MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и внесете го кодот подолу за да ја поврзете вашата сметка и да користите {{provider}} модели во MindScript Studio.",
  ...
  "dialog.server.description": "Променете на кој MindScript Studio сервер се поврзува оваа апликација.",
  ...
  "wsl.onboarding.checkingOpencode": "Се проверува MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Се проверува MindScript Studio во {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Се ажурира MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Се ажурира MindScript Studio во {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ажурирајте MindScript Studio во {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ажурирај MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio е подготвен во {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio е подготвен.",
  "wsl.onboarding.installOpencodeIn": "Инсталирајте MindScript Studio во {{distro}}.",
  "wsl.onboarding.installOpencode": "Инсталирај MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) е потребно пред MindScript Studio да може да додаде WSL сервер",
  "wsl.onboarding.wslUnavailable.title": "WSL недостапен",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio не можеше да го потврди WSL на оваа машина.",
  "wsl.onboarding.installWsl": "Инсталирај WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирајте го Windows за да завршите со инсталирањето WSL, а потоа повторно отворете MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop сега е изграден околу картичките.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новата верзија на MindScript Studio ({{version}}) сега е достапна за инсталирање.",
  ...
  "error.page.report.prefix": "Ве молиме пријавете ја оваа грешка на тимот MindScript Studio",
  ...
  "error.chain.mcpFailed":
    "MCP серверот „{{name}}“ не успеа. Забелешка, MindScript Studio сè уште не поддржува автентикација MCP.",
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio вклучува бесплатни модели за да можете веднаш да започнете.",
  ...
  "settings.desktop.wsl.description": "Стартувај го серверот MindScript Studio во WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете го јазикот на прикажување за MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Приспособете како изгледа MindScript Studio на вашиот уред",
  "settings.general.row.colorScheme.title": "Шема на бои",
  "settings.general.row.colorScheme.description": "Изберете дали MindScript Studio ја следи системската, светла или темна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Приспособете како MindScript Studio е тематизирана.",
  ...
  "settings.updates.row.startup.description": "Автоматски проверувајте дали има ажурирања кога ќе се стартува MindScript Studio",
  ...
  "settings.updates.toast.latest.description": "Ја извршувате најновата верзија на MindScript Studio.",
