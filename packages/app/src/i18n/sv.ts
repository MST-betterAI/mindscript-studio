export const dict = {
  ...
  "desktop.recovery.loadFailed": "MindScript Studio kunde inte läsas in",
  "desktop.recovery.terminated": "MindScript Studio-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "MindScript Studio svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av MindScript Studio misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i MindScript Studio.",
  ...
  "dialog.server.description": "Växla vilken MindScript Studio-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar MindScript Studio i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar MindScript Studio i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera MindScript Studio i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera MindScript Studio i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan MindScript Studio kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan MindScript Studio igen.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av MindScript Studio ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till MindScript Studio-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, MindScript Studio stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör MindScript Studio-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Anpassa hur MindScript Studio ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om MindScript Studio följer system-, ljus- eller mörktemat",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när MindScript Studio startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av MindScript Studio.",
