export const dict = {
  ...
  "desktop.recovery.loadFailed": "MindScript Studio መጫን አልቻለም",
  "desktop.recovery.terminated": "MindScript Studio መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "MindScript Studio ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "MindScript Studioመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በMindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በMindScript Studio ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "MindScript Studio ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በMindScript Studio ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በMindScript Studio ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው MindScript Studio አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "MindScript Studioን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ MindScript Studio በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን MindScript Studio በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "MindScript Studio ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን MindScript Studio በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studioአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) MindScript Studio WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ MindScript Studio።",
  ...
  "help.tabs.introduction": "MindScript Studio ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የMindScript Studio ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለMindScript Studio ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ MindScript Studio እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "MindScript Studio ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የMindScript Studio አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለMindScript Studio",
  ...
  "settings.general.row.appearance.description": "MindScript Studioበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "MindScript Studio ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "MindScript Studio ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "MindScript Studio ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የMindScript Studio እትም እያሄዱ ነው።",
