...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in MindScript Studio zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in MindScript Studio zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in MindScript Studio zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den MindScript Studio-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "MindScript Studio wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "MindScript Studio in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "MindScript Studio wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "MindScript Studio in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie MindScript Studio in {{distro}}.",
  "wsl.onboarding.updateOpencode": "MindScript Studio aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "MindScript Studio ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie MindScript Studio in {{distro}}.",
  "wsl.onboarding.installOpencode": "MindScript Studio installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor MindScript Studio einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann MindScript Studio erneut.",
  ...
  "toast.update.description": "Eine neue Version von MindScript Studio ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem MindScript Studio-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: MindScript Studio unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "MindScript Studio mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "MindScript Studio-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für MindScript Studio ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie MindScript Studio auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob MindScript Studio dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von MindScript Studio anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von MindScript Studio automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "MindScript Studio ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von MindScript Studio wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das MindScript Studio-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "MindScript Studio reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "MindScript Studio-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das MindScript Studio-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
