export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de MindScript Studio",
  ...
  "desktop.menu.ariaLabel": "Menú de MindScript Studio",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar MindScript Studio",
  "desktop.recovery.terminated": "La ventana de MindScript Studio se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "MindScript Studio no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar MindScript Studio",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de MindScript Studio finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en MindScript Studio.",
  ...
  "dialog.server.description": "Cambiar el servidor de MindScript Studio al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando MindScript Studio en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando MindScript Studio en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza MindScript Studio en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala MindScript Studio en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que MindScript Studio pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de MindScript Studio ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de MindScript Studio",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: MindScript Studio aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor MindScript Studio dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve MindScript Studio en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si MindScript Studio sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de MindScript Studio.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia MindScript Studio",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de MindScript Studio.",
