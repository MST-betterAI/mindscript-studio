export const dict = {
  ...
  "desktop.menu.documentation": "MindScript Studio Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "MindScript Studio μενού",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "MindScript Studio το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "MindScript Studio δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOpencode": "MindScript Studio η εγκατάσταση απέτυχε",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο MindScript Studio.",
  ...
  "provider.connect.opencodeZen.line1":
    "MindScript Studio Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο MindScript Studio.",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή MindScript Studio συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOpencode": "Έλεγχος MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Έλεγχος MindScript Studio σε {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ενημέρωση MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Ενημέρωση MindScript Studio σε {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ενημέρωση MindScript Studio σε {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ενημέρωση MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio είναι έτοιμο.",
  "wsl.onboarding.installOpencodeIn": "Εγκατάσταση του MindScript Studio στο {{distro}}.",
  "wsl.onboarding.installOpencode": "Εγκατάσταση MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο MindScript Studio να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του MindScript Studio ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα MindScript Studio",
  ...
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το MindScript Studio δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "MindScript Studio Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή MindScript Studio μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του MindScript Studio στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το MindScript Studio ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το MindScript Studio.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του MindScript Studio",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του MindScript Studio.",
