export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in MindScript Studio.",
  ...
  "dialog.server.description": "Cambia il server MindScript Studio a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo MindScript Studio in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento MindScript Studio in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna MindScript Studio in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa MindScript Studio in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che MindScript Studio possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di MindScript Studio ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team MindScript Studio",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: MindScript Studio non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server MindScript Studio all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di MindScript Studio sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se MindScript Studio segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di MindScript Studio.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di MindScript Studio",
  ...
  "settings.updates.toast.latest.title": "MindScript Studio è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di MindScript Studio.",
  ...
  "desktop.menu.documentation": "Documentazione di MindScript Studio",
  ...
  "desktop.menu.ariaLabel": "Menu MindScript Studio",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare MindScript Studio",
  "desktop.recovery.terminated": "La finestra di MindScript Studio si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "MindScript Studio non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di MindScript Studio non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di MindScript Studio è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
