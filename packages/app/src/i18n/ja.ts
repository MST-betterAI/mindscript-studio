export const dict = {
  ...
  "desktop.recovery.loadFailed": "MindScript Studioを読み込めませんでした",
  "desktop.recovery.terminated": "MindScript Studioのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "MindScript Studioが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "MindScript Studioのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはMindScript Studioがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "MindScript Studioのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "MindScript Studioが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、MindScript Studioで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してMindScript Studioで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、MindScript Studioで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するMindScript Studioサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "MindScript Studioを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のMindScript Studioを確認中...",
  "wsl.onboarding.updatingOpencode": "MindScript Studioを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のMindScript Studioを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のMindScript Studioを更新してください。",
  "wsl.onboarding.updateOpencode": "MindScript Studioを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のMindScript Studioの準備ができました。",
  "wsl.onboarding.opencodeReady": "MindScript Studioの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にMindScript Studioをインストールしてください。",
  "wsl.onboarding.installOpencode": "MindScript Studioをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studioがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MindScript StudioでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、MindScript Studioをもう一度開いてください。",
  ...
  "help.tabs.introduction": "MindScript Studio Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MindScript Studioの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをMindScript Studioチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: MindScript StudioはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studioには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でMindScript Studioサーバーを実行します。",
  ...
  "settings.general.row.language.description": "MindScript Studioの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのMindScript Studioの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "MindScript Studioがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "MindScript Studioのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "MindScript Studio の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "MindScript Studio は最新バージョンです。",
