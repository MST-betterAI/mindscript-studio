export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'MindScript Studio",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'MindScript Studio",
  "desktop.recovery.terminated": "La fenêtre MindScript Studio s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "MindScript Studio ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'MindScript Studio",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'MindScript Studio est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans MindScript Studio.",
  ...
  "dialog.server.description": "Changez le serveur MindScript Studio auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'MindScript Studio dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'MindScript Studio dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour MindScript Studio dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez MindScript Studio dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'MindScript Studio puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'MindScript Studio ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe MindScript Studio",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'MindScript Studio ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "MindScript Studio inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur MindScript Studio dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'MindScript Studio sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si MindScript Studio suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'MindScript Studio.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'MindScript Studio",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'MindScript Studio.",
