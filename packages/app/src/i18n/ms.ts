export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi MindScript Studio",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap MindScript Studio ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "MindScript Studio tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan MindScript Studio gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini MindScript Studio selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam MindScript Studio.",
  ...
  "dialog.server.description": "Tukar pelayan MindScript Studio yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak MindScript Studio dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini MindScript Studio dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini MindScript Studio dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang MindScript Studio dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum MindScript Studio boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu MindScript Studio ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan MindScript Studio",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, MindScript Studio belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan MindScript Studio dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa MindScript Studio pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada MindScript Studio mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema MindScript Studio.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila MindScript Studio dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini MindScript Studio.",
