...
const desktop = [
  ...
  "Suskleisti",
  "Išskleisti",
  "MindScript Studio dokumentacija",
  "Pagalbos forumas",
  "Pateikti atsiliepimą",
  "Pranešti apie klaidą",
  "MindScript Studio meniu",
  ...
  "Laukti toliau",
  "Baigti darbą",
  "MindScript Studio įkelti nepavyko",
  "MindScript Studio langas netikėtai užsidarė",
  "MindScript Studio neatsako",
  ...
  "MindScript Studio įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "MindScript Studio neįdiegtas distributyve {{distro}}",
  "MindScript Studio naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami MindScript Studio modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius MindScript Studio.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio MindScript Studio serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama MindScript Studio {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas MindScript Studio {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite MindScript Studio {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite MindScript Studio į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad MindScript Studio galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio nepavyko patikrinti WSL šiame įrenginyje.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują MindScript Studio ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą MindScript Studio komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad MindScript Studio dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "MindScript Studio darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite MindScript Studio serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite MindScript Studio ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip MindScript Studio atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar MindScript Studio seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite MindScript Studio temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas MindScript Studio",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią MindScript Studio versiją.",
