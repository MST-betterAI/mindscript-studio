export const dict = {
  ...
  "desktop.recovery.loadFailed": "MindScript Studio yüklənə bilmədi",
  "desktop.recovery.terminated": "MindScript Studio pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "MindScript Studio cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "MindScript Studio quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "MindScript Studio tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və MindScript Studio-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və MindScript Studio-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və MindScript Studio-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu MindScript Studio serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "MindScript Studio yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də MindScript Studio yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "MindScript Studio yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də MindScript Studio yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də MindScript Studio-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "MindScript Studio-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "MindScript Studio hazırdır.",
  "wsl.onboarding.installOpencodeIn": "MindScript Studio-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "MindScript Studio quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "MindScript Studio WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra MindScript Studio-u yenidən açın.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MindScript Studio-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı MindScript Studio komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: MindScript Studio hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində MindScript Studio serverini işlət.",
  ...
  "settings.general.row.language.description": "MindScript Studio üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "MindScript Studio-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "MindScript Studio-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "MindScript Studio-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "MindScript Studio açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "MindScript Studio-un ən son versiyasından istifadə edirsiniz.",
