export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni MindScript Studio",
  ...
  "desktop.menu.ariaLabel": "Menuja MindScript Studio",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja MindScript Studio u mbyll papritur",
  "desktop.recovery.unresponsive": "MindScript Studio nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i MindScript Studio dështoi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i MindScript Studio përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në MindScript Studio.",
  ...
  "dialog.server.description": "Ndrysho me cilin server MindScript Studio lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon MindScript Studio në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "MindScript Studio po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson MindScript Studio në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso MindScript Studio në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio është gati në {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni MindScript Studio në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se MindScript Studio të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i MindScript Studio ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i MindScript Studio",
  ...
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, MindScript Studio nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin MindScript Studio brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket MindScript Studio në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse MindScript Studio ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e MindScript Studio.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset MindScript Studio",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të MindScript Studio.",
