export const dict = {
  ...
  "desktop.recovery.loadFailed": "MindScript Studio gagal dimuat",
  "desktop.recovery.terminated": "Jendela MindScript Studio berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "MindScript Studio tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi MindScript Studio gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan MindScript Studio selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di MindScript Studio.",
  ...
  "dialog.server.description": "Ganti server MindScript Studio mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa MindScript Studio di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui MindScript Studio di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui MindScript Studio di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio siap.",
  "wsl.onboarding.installOpencodeIn": "Instal MindScript Studio di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum MindScript Studio dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru MindScript Studio ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim MindScript Studio",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: MindScript Studio belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server MindScript Studio di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan MindScript Studio di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah MindScript Studio mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat MindScript Studio diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru MindScript Studio.",
