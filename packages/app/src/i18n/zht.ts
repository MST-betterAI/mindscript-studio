...
export const dict = {
  ...
  "desktop.menu.documentation": "MindScript Studio 文件",
  "desktop.menu.supportForum": "支援論壇",
  "desktop.menu.shareFeedback": "提供意見回饋",
  "desktop.menu.reportBug": "回報錯誤",
  "desktop.menu.ariaLabel": "MindScript Studio 選單",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio 載入失敗",
  "desktop.recovery.terminated": "MindScript Studio 視窗意外終止",
  "desktop.recovery.unresponsive": "MindScript Studio 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "MindScript Studio 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 MindScript Studio",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "MindScript Studio 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 MindScript Studio 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 MindScript Studio 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 MindScript Studio 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 MindScript Studio 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 MindScript Studio...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 MindScript Studio 已就緒。",
  "wsl.onboarding.opencodeReady": "MindScript Studio 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 MindScript Studio。",
  "wsl.onboarding.installOpencode": "安裝 MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 MindScript Studio",
  ...
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 MindScript Studio。",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MindScript Studio 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 MindScript Studio 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：MindScript Studio 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 MindScript Studio 伺服器。",
  ...
  "settings.general.row.language.description": "變更 MindScript Studio 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 MindScript Studio 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 MindScript Studio 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 MindScript Studio 的主題。",
  ...
  "settings.updates.row.startup.description": "在 MindScript Studio 啟動時自動檢查更新",
