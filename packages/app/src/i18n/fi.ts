export const dict = {
  ...
  "dialog.server.description": "Vaihda MindScript Studio-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.updateOpencodeIn": "Päivitä MindScript Studio jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna MindScript Studio jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna MindScript Studio",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin MindScript Studio voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten MindScript Studio uudelleen.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä MindScript Studio-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että MindScript Studio ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita MindScript Studio-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä MindScript Studio näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö MindScript Studio järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun MindScript Studio käynnistyy",
  ...
  "desktop.menu.documentation": "MindScript Studio-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "MindScript Studio-valikko",
  ...
  "desktop.recovery.terminated": "MindScript Studio-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "MindScript Studio ei vastaa",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
