export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja MindScript Studio",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać MindScript Studio",
  "desktop.recovery.terminated": "Okno MindScript Studio zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "MindScript Studio nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować MindScript Studio",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja MindScript Studio została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w MindScript Studio.",
  ...
  "dialog.server.description": "Przełącz serwer MindScript Studio, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie MindScript Studio w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie MindScript Studio w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj MindScript Studio w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj MindScript Studio w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim MindScript Studio będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja MindScript Studio ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu MindScript Studio",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: MindScript Studio nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer MindScript Studio wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd MindScript Studio na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy MindScript Studio ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw MindScript Studio.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania MindScript Studio",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji MindScript Studio.",
