export const dict = {
  ...
  "desktop.menu.documentation": "MindScript Studio دستاویزات",
  ...
  "desktop.menu.ariaLabel": "MindScript Studio مینو",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "MindScript Studio ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "MindScript Studio جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "MindScript Studio کی تنصیب ناکام ہو گئی",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں MindScript Studio انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.model.unpaid.freeModels.title": "MindScript Studio کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور MindScript Studio میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور MindScript Studio میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور MindScript Studio میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس MindScript Studio سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "MindScript Studio چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں MindScript Studio چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "MindScript Studio کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں MindScript Studio کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں MindScript Studio کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "MindScript Studio کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "MindScript Studio تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں MindScript Studio انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "MindScript Studio انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ MindScript Studio WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر MindScript Studio کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MindScript Studio ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم MindScript Studio ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، MindScript Studio ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "MindScript Studio ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر MindScript Studio سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "MindScript Studio کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر MindScript Studio کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا MindScript Studio سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "MindScript Studio کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "MindScript Studio لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ MindScript Studio کا تازہ ترین ورژن چلا رہے ہیں۔",
