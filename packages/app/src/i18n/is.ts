...
const desktop = [
  ...
  "Lágmarka",
  "Hámarka",
  "MindScript Studio skjölun",
  "Aðstoðarspjallborð",
  "Deila ábendingu",
  "Tilkynna villu",
  "MindScript Studio-valmynd",
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða MindScript Studio",
  "MindScript Studio-glugganum var óvænt lokað",
  "MindScript Studio svarar ekki",
  ...
  "Uppsetning MindScript Studio mistókst",
  ...
  "MindScript Studio er ekki uppsett í {{distro}}",
  "Uppfærslu MindScript Studio lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í MindScript Studio.",
  ...
  "dialog.server.description": "Skiptu um hvaða MindScript Studio miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar MindScript Studio í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir MindScript Studio í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu MindScript Studio í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp MindScript Studio í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en MindScript Studio getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan MindScript Studio aftur.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af MindScript Studio ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til MindScript Studio teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, MindScript Studio styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "MindScript Studio skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu MindScript Studio netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig MindScript Studio lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort MindScript Studio fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig MindScript Studio er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar MindScript Studio ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af MindScript Studio.",
