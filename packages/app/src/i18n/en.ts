...
export const dict = {
  ...
  "session.link.copied.title": "Link copied",
  "session.link.copied.description": "Paste it into the desktop app or the VS Code panel.",
  "session.link.invalid.title": "That is not a conversation link",
  "session.link.invalid.description": "Copy the address of a conversation first, then run this again.",
  "session.link.otherServer.title": "That conversation is on a different server",
  "session.link.otherServer.description": "The link points at {{origin}}. Switch servers first, then open it again.",
  "session.link.notFound.title": "Conversation not found",
  "session.link.notFound.description": "{{sessionID}} is not on this server, or is not in {{directory}}.",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in MindScript Studio.",
  ...
  "dialog.server.description": "Switch which MindScript Studio server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "MindScript Studio",
  ...
  "wsl.onboarding.checkingOpencode": "Checking MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Checking MindScript Studio in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Updating MindScript Studio in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update MindScript Studio in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio is ready.",
  "wsl.onboarding.installOpencodeIn": "Install MindScript Studio in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before MindScript Studio can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen MindScript Studio.",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of MindScript Studio ({{version}}) is now available to install.",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, MindScript Studio does not support MCP authentication yet.',
  ...
  "home.sessions.failed": "Could not load conversations",
  "home.sessions.failed.retry": "Try again",
  "home.sessions.filtered.empty": "No conversations in {{project}}",
  "home.sessions.filtered.empty.description": "This project has none yet. Other projects on this server may.",
  "home.sessions.filtered.clear": "Show all conversations",
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio includes free models so you can start immediately.",
  ...
  "app.name.desktop": "MindScript Studio Desktop",
  ...
  "settings.desktop.wsl.description": "Run the MindScript Studio server inside WSL on Windows.",

  "settings.routing.section.title": "Routing",
  "settings.routing.section.models": "Available AIs",
  "settings.routing.row.auto.title": "Let MindScript choose",
  "settings.routing.row.auto.description":
    "MindScript balances intelligence, speed and cost for each request. Turn this off to set the balance yourself.",
  "settings.routing.row.auto.button": "Auto",
  "settings.routing.row.intelligence.title": "Intelligence",
  "settings.routing.row.intelligence.description": "Favour the most capable models.",
  "settings.routing.row.speed.title": "Speed",
  "settings.routing.row.speed.description": "Favour the fastest models.",
  "settings.routing.row.cost.title": "Cost",
  "settings.routing.row.cost.description": "Favour the cheapest models.",
  "settings.routing.row.verbosity.title": "Verbosity",
  "settings.routing.row.verbosity.description": "How much detail replies should include.",
  "settings.routing.row.maxPrice.title": "Max price per query",
  "settings.routing.row.maxPrice.description": "The most MindScript may spend answering a single question.",
  "settings.routing.row.maxPrice.placeholder": "No limit",
  "settings.routing.priorities.hint": "Intelligence, speed and cost share one budget: raising one lowers the others.",
  ...
  "settings.routing.notConnected":
    "Unticking an AI stops MindScript routing to it. Asking for a model by name still works.",
  "settings.routing.localOnly":
    "Intelligence, speed, cost and the AI list are saved to your account and apply everywhere. Verbosity and the price cap are saved on this device only and do not change routing yet.",
  ...
  "settings.general.row.language.description": "Change the display language for MindScript Studio",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how MindScript Studio looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether MindScript Studio follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how MindScript Studio is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when MindScript Studio launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of MindScript Studio.",
