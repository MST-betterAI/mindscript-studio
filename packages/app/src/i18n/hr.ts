...
const desktop = [
  ...
  "Minimiziraj",
  "Maksimiziraj",
  "Dokumentacija za MindScript Studio",
  "Forum za podršku",
  "Pošalji povratne informacije",
  "Prijavi pogrešku",
  "Izbornik MindScript Studio",
  ...
  "Nastavi čekati",
  "Izađi",
  "MindScript Studio se nije uspio učitati",
  "Prozor aplikacije MindScript Studio neočekivano je zatvoren",
  "MindScript Studio ne reagira",
  ...
  "Instalacija aplikacije MindScript Studio nije uspjela",
  ...
  "MindScript Studio nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije MindScript Studio je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u MindScript Studio.",
  ...
  "dialog.server.description": "Promijenite na koji se MindScript Studio poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera MindScript Studio u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje MindScript Studio u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte MindScript Studio u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte MindScript Studio u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte MindScript Studio",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što MindScript Studio može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite MindScript Studio.",
  ...
  "help.tabs.introduction": "Radna površina MindScript Studio sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija MindScript Studio ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku MindScript Studio timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, MindScript Studio još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "MindScript Studio Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite MindScript Studio poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako MindScript Studio izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li MindScript Studio slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je MindScript Studio tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se MindScript Studio pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju MindScript Studio.",
