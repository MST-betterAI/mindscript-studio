export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do MindScript Studio",
  ...
  "desktop.menu.ariaLabel": "Menu do MindScript Studio",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o MindScript Studio",
  "desktop.recovery.terminated": "A janela do MindScript Studio foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O MindScript Studio não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do MindScript Studio",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O MindScript Studio não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do MindScript Studio foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no MindScript Studio.",
  ...
  "dialog.server.description": "Trocar para qual servidor MindScript Studio este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o MindScript Studio em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o MindScript Studio em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o MindScript Studio em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "O MindScript Studio está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O MindScript Studio está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o MindScript Studio em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o MindScript Studio possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O MindScript Studio não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o MindScript Studio novamente.",
  ...
  "help.tabs.introduction": "Agora, o MindScript Studio Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do MindScript Studio ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do MindScript Studio",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: MindScript Studio ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor MindScript Studio dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Personalize como o MindScript Studio aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o MindScript Studio segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o MindScript Studio é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o MindScript Studio iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do MindScript Studio.",
