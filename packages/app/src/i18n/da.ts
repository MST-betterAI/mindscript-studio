export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i MindScript Studio.",
  ...
  "dialog.server.description": "Skift hvilken MindScript Studio-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker MindScript Studio i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer MindScript Studio i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater MindScript Studio i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før MindScript Studio kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter MindScript Studio igen.",
  ...
  "toast.update.description": "En ny version af MindScript Studio ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til MindScript Studio-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, MindScript Studio understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør MindScript Studio-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan MindScript Studio ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om MindScript Studio skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når MindScript Studio starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af MindScript Studio.",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio kunne ikke indlæses",
  "desktop.recovery.terminated": "MindScript Studio-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af MindScript Studio mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af MindScript Studio er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
