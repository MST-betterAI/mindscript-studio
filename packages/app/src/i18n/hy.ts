export const dict = {
  ...
  "desktop.menu.documentation": "MindScript Studio Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "MindScript Studio մենյու",
  ...
  "desktop.recovery.loadFailed": "MindScript Studio չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "MindScript Studio պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "MindScript Studio-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "MindScript Studio տեղադրումը ձախողվեց",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "MindScript Studio թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և MindScript Studio-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և MindScript Studio-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և MindScript Studio-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ MindScript Studio սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է MindScript Studio-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է MindScript Studio-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել MindScript Studio-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.opencodeReady": "MindScript Studio պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք MindScript Studio-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի MindScript Studio-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "MindScript Studio-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք MindScript Studio։",
  ...
  "help.tabs.introduction": "MindScript Studio Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "MindScript Studio-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին MindScript Studio թիմին",
  ...
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ MindScript Studio-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "MindScript Studio ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք MindScript Studio սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն MindScript Studio",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է MindScript Studio տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ MindScript Studio-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է MindScript Studio-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ MindScript Studio-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք MindScript Studio-ի վերջին տարբերակը։",
