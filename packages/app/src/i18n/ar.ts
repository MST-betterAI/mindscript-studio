export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل MindScript Studio",
  "desktop.recovery.terminated": "توقفت نافذة MindScript Studio بشكل غير متوقع",
  "desktop.recovery.unresponsive": "MindScript Studio لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت MindScript Studio",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "MindScript Studio غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث MindScript Studio، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من MindScript Studio",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في MindScript Studio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في MindScript Studio.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في MindScript Studio.",
  ...
  "dialog.server.description": "تبديل خادم MindScript Studio الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من MindScript Studio...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من MindScript Studio في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث MindScript Studio...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث MindScript Studio في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث MindScript Studio في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث MindScript Studio",
  "wsl.onboarding.opencodeReadyIn": "MindScript Studio جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "MindScript Studio جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت MindScript Studio في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت MindScript Studio",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MindScript Studio غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن MindScript Studio من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على MindScript Studio التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح MindScript Studio.",
  ...
  "help.tabs.introduction": "أصبح MindScript Studio Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من MindScript Studio ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق MindScript Studio",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن MindScript Studio لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن MindScript Studio نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم MindScript Studio داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ MindScript Studio",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور MindScript Studio على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان MindScript Studio يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة MindScript Studio.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل MindScript Studio",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من MindScript Studio.",
