...
const TIPS: Tip[] = [
  ...
  "Use {highlight}mindscript run{/highlight} for non-interactive scripting",
  "Use {highlight}mindscript --continue{/highlight} to resume the last session",
  "Use {highlight}mindscript run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}mindscript serve{/highlight} for headless API access to MindScript Studio",
  "Use {highlight}mindscript run --attach{/highlight} to connect to a running server",
  "Run {highlight}mindscript upgrade{/highlight} to update to the latest version",
  "Run {highlight}mindscript auth list{/highlight} to see all configured providers",
  "Run {highlight}mindscript agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}mindscript github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}mindscript debug config{/highlight} to troubleshoot configuration",
