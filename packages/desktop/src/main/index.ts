...
const APP_NAMES: Record<string, string> = {
  dev: "MindScript Studio Dev", // mindscript_change
  beta: "MindScript Studio Beta",
  prod: "MindScript Studio",
}
const APP_IDS: Record<string, string> = {
  dev: "ai.mindscript.studio.dev", // mindscript_change
...
const main = Effect.gen(function* () {
  ...
  const appId = app.isPackaged ? APP_IDS[CHANNEL] : "ai.mindscript.studio.dev" // mindscript_change
  ...
  app.setName(app.isPackaged ? APP_NAMES[CHANNEL] : "MindScript Studio Dev") // mindscript_change
  ...
  app.on("second-instance", (_event: Event, argv: string[]) => {
    const urls = argv.filter((arg: string) => arg.startsWith("mindscript://")) // mindscript_change
    if (urls.length) {
  ...
  app.setAsDefaultProtocolClient("mindscript") // mindscript_change
  registerRendererProtocol()
  setDockIcon()
