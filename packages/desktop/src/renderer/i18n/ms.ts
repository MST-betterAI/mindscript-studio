export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} MindScript Studio telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
