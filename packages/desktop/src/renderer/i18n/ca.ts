export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent d'MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} d'MindScript Studio. Voleu instal·lar-la i reiniciar l'aplicació?",
