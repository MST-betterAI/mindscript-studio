export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko MindScript Studio versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "MindScript Studio versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
