export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք MindScript Studio-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "MindScript Studio-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
