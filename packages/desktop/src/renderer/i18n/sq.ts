export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i MindScript Studio është shkarkuar, dëshironi ta instaloni dhe rinisni?",
