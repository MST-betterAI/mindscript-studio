export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af MindScript Studio er blevet downloadet. Vil du installere den og genstarte?",
