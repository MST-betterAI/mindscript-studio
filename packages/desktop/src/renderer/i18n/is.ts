export const dict = {
  ...
  "desktop.updater.none.message": "Þú ert nú þegar að nota nýjustu útgáfuna af MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáfu {{version}} af MindScript Studio hefur verið hlaðið niður. Viltu setja hana upp og endurræsa?",
