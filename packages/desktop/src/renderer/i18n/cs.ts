export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace MindScript Studio. Chcete ji nainstalovat a aplikaci znovu spustit?",
