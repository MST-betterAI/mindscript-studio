export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von MindScript Studio wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
