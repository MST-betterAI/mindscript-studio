export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} MindScript Studio. Czy chcesz ją zainstalować i uruchomić ponownie?",
