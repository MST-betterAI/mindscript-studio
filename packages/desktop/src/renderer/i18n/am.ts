export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የMindScript Studio ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከMindScript Studio ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
