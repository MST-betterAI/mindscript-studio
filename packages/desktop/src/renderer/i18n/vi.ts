export const dict = {
  ...
  "desktop.updater.none.message": "Bạn đang sử dụng phiên bản mới nhất của MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Phiên bản {{version}} của MindScript Studio đã được tải xuống, bạn có muốn cài đặt và khởi chạy lại không?",
