export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di MindScript Studio è stata scaricata. Vuoi installarla e riavviare l'app?",
