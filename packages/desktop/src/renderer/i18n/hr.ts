export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije MindScript Studio. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
