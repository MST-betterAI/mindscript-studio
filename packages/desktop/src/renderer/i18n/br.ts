export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do MindScript Studio foi baixada. Você gostaria de instalá-la e reiniciar?",
