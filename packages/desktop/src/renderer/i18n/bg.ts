export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от MindScript Studio е изтеглена. Искате ли да я инсталирате и рестартирате?",
