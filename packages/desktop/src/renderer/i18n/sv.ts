export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av MindScript Studio har laddats ned. Vill du installera den och starta om programmet?",
