export const dict = {
  ...
  "desktop.updater.none.message": "Používate najnovšiu verziu MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzia {{version}} MindScript Studio bola stiahnutá. Chcete ju nainštalovať a reštartovať?",
