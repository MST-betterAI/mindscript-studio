export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju MindScript Studio-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} MindScript Studio-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
