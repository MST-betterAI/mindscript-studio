export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of MindScript Studio has been downloaded, would you like to install it and relaunch?",
