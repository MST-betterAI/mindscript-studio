export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de MindScript Studio. ¿Quieres instalarla y reiniciar?",
