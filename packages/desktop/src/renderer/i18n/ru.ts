export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt": "Версия MindScript Studio {{version}} загружена. Хотите установить и перезапустить?",
