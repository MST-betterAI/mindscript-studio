export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią MindScript Studio versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "MindScript Studio versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
