export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse MindScript Studio uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "MindScript Studio'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
