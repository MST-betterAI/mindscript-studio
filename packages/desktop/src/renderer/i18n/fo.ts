export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av MindScript Studio.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av MindScript Studio er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
