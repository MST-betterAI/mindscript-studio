export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} MindScript Studio a fost descărcată. Vrei să o instalezi și să repornești?",
