export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'MindScript Studio a été téléchargée. Voulez-vous l'installer et relancer l'application ?",
