export const dict = {
  ...
  "desktop.updater.none.message": "Már az MindScript Studio legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az MindScript Studio {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
