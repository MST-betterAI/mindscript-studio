export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} MindScript Studio je bila prenesena, jo želite namestiti in znova zagnati?",
