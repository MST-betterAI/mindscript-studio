export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "MindScript Studio versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
