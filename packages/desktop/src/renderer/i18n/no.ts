export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av MindScript Studio er lastet ned. Vil du installere den og starte på nytt?",
