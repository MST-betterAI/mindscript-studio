export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "تم تنزيل الإصدار {{version}} من MindScript Studio. هل ترغب في تثبيته وإعادة تشغيل التطبيق؟",
