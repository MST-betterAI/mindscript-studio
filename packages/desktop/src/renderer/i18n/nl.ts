export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van MindScript Studio",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van MindScript Studio is gedownload. Wil je deze installeren en MindScript Studio opnieuw starten?",
